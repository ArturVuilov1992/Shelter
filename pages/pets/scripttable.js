...
function carousel_left() {
    CAROUSEL.classList.add("carousel-left_tablet");
...
function carousel_right() {
    CAROUSEL.classList.add("carousel-right_tablet");
    arrowLeft.removeEventListener("click", carousel_left)
    arrowRight.removeEventListener("click", carousel_right)
}
...
CAROUSEL.addEventListener("animationend", (animationEvent) => {
    let changedItem;
   if (animationEvent.animationName === "carousel-left_tablet") {
    CAROUSEL.classList.remove("carousel-left_tablet");
    ...
    CAROUSEL.classList.remove("carousel-right_tablet");
